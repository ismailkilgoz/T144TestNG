...
public class C03_RaporluNegatifLoginTesti extends TestBaseRapor {
    ...
    public void negativeLoginTest(){
        ...
        extentTest = extentReports.createTest("Gecersiz password testi",
                "Kullanici gecersiz password ile sisteme giris yapamamali");
        ...
        extentTest.info("gecerli email, gecersiz password yazar");

        // 4- Login butonuna basarak login olmayi deneyin
        testOtomasyonuPage.loginSignInButonu.click();
        extentTest.info("Login butonuna basar ve login olmayi dener");
